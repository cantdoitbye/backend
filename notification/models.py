...
class UserNotification(models.Model):
    ...
    click_action = models.CharField(max_length=500, null=True, blank=True, help_text="Click action path")
    deep_link = models.CharField(max_length=500, null=True, blank=True, help_text="Deep link for mobile app (e.g., ooumph://post/123)")
    web_link = models.URLField(max_length=500, null=True, blank=True, help_text="Web link for browser (e.g., https://app.ooumph.com/post/123)")
