    ...
    def create_user_profiles(self, users, interests):
        ...
        for user in users:
            ...
            FeedComposition.objects.get_or_create(
                user=user,
                defaults={
                    'personal_connections': random.uniform(0.3, 0.5),
                    'interest_based': random.uniform(0.2, 0.3),
                    'trending_content': random.uniform(0.1, 0.2),
                    'discovery_content': random.uniform(0.05, 0.15),
                    'community_content': random.uniform(0.02, 0.08),
                    'product_content': random.uniform(0.02, 0.08)
                }
            )
