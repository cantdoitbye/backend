...
def docs_home(request):
    ...
    <head>
        ...
        <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            .header h1 { font-size: 3.5em; margin-bottom: 20px; font-weight: 300; }
    ...
    <body>
        <div class="header">
            <div class="container">
                <h1>🚀 OOUMPH API</h1>
                <p>Comprehensive documentation for developers and integrators</p>
            </div>
        </div>
            ...
            <div class="container">
                <div class="intro-content">
                    <div class="intro-text">
                        <h2>Welcome to OOUMPH API</h2>
                        <p>A powerful GraphQL API for building social community platforms with advanced features like user management, community creation, real-time messaging, and content sharing.</p>
                        <p>Our API is designed to be developer-friendly with comprehensive documentation, interactive examples, and clear guides for integration.</p>
                        
                        <ul class="feature-list">
                            <li>Community Management & Social Features</li>
                            <li>User Authentication & Profiles</li>
                            <li>Real-time Messaging Integration</li>
                            <li>Content Sharing & Media Upload</li>
                            <li>Comprehensive Permission System</li>
                            <li>Two API Versions for Flexibility</li>
                        </ul>
                    </div>
                    <div style="text-align: center;">
                        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 20px; padding: 40px; color: white;">
                            <h3 style="margin-bottom: 20px;">🎯 Ready to Start?</h3>
                            <p style="margin-bottom: 30px;">Choose how you want to explore the API:</p>
                            <a href="/docs/reference/" style="display: inline-block; background: white; color: #667eea; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: 500; margin: 5px;">📖 Browse Documentation</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="nav-section">
            <div class="container">
                <h2 style="text-align: center; font-size: 2.5em; margin-bottom: 20px; color: #2d3748;">Explore the API</h2>
                <p style="text-align: center; font-size: 1.2em; color: #4a5568; max-width: 600px; margin: 0 auto;">Choose the documentation format that works best for you</p>
                
                <div class="nav-grid">
                    <a href="/docs/reference/" class="nav-card">
                        <span class="icon">📖</span>
                        <h3>API Reference</h3>
                        <p>Complete documentation of all queries, mutations, and types. Perfect for developers who want detailed information about each endpoint.</p>
                    </a>
                    
                    <a href="/docs/guide/" class="nav-card">
                        <span class="icon">🎯</span>
                        <h3>Integration Guide</h3>
                        <p>Step-by-step guides for common use cases. Learn how to implement features like user authentication, community management, and more.</p>
                    </a>
                    
                    <a href="/graphql/" class="nav-card" target="_blank">
                        <span class="icon">🎮</span>
                        <h3>Interactive Playground</h3>
                        <p>Test queries and mutations in real-time. Explore the schema interactively and see live results from your API calls.</p>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="api-overview">
            <div class="container">
                <h2 style="text-align: center; font-size: 2.5em; margin-bottom: 20px; color: #2d3748;">API Versions</h2>
                ...
                <div class="version-cards">
                    <div class="version-card">
                        ...
                        <p>The stable version of our API with core features including community management, user authentication, and basic social functionality. Recommended for production applications.</p>
                        <p style="margin-top: 20px;">
                            <a href="/docs/reference/?version=v1" style="color: #667eea; text-decoration: none; font-weight: 500;">📖 V1 Documentation →</a>
                        </p>
                    </div>
                    ...
                    <div class="version-card">
                        ...
                        <h3>Version 2</h3>
                        <p><strong>Endpoint:</strong> <code>/graphql/v2/</code></p>
                        <p>The latest version with enhanced features, improved performance, and additional endpoints. Includes advanced community features and better integration options.</p>
                        <p style="margin-top: 20px;">
                            <a href="/docs/reference/?version=v2" style="color: #667eea; text-decoration: none; font-weight: 500;">📖 V2 Documentation →</a>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div style="background: #2d3748; color: white; padding: 40px 0; text-align: center;">
            <div class="container">
                <h3 style="margin-bottom: 15px;">Need Help?</h3>
                <p>Our API documentation is designed to be comprehensive and easy to follow. If you need assistance, start with our integration guides.</p>
            </div>
        </div>
    </body>
    </html>
